...
def assign_tunnel_positions(
    ...
    """
    logger.info("Assigning tunnel positions based on MST with relative offset correction")
    ...
    logger.info("Tunnel positions assigned successfully with relative offset correction")
...
def assign_entry_exit_tunnels(
    ...
    if entry_position is not None:
        ...
        logger.info(f"Entry tunnel assigned: Layer 0 Chunk {entry_chunk.chunk_id} at row {entry_position}")
    else:
        ...
        logger.info(f"Entry tunnel assigned (random): Layer 0 Chunk {entry_chunk.chunk_id} at row {random_row}")
